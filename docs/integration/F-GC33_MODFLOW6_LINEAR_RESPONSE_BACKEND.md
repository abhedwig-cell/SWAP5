> Authority correction: this current-canonical F-GC33 uses canonical F-GC40 for the MultiSWAP cell response. Canonical F-GC31 remains the active-drainage tangent authority. Production F-GC33 source/test blobs are unchanged from the historical owner-qualified work.

# F-GC33 — MODFLOW6 linear response backend

## Status

**CURRENT-CANONICAL REQUALIFICATION PENDING**
