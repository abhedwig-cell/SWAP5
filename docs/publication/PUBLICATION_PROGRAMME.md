...
- GMD pre-submission checklist, editor-letter draft, figure PDF export plan and manuscript-format audit are prepared; remaining blockers are A1 release/version authority, A2 licence/redistribution authority, A3 persistent archive/PID, and author/declaration metadata.
