...
- F1–F6 and T1–T5 are built and evidence-bound; the externally checked working bibliography and submission-readiness audit identify E7 as the only remaining scientific evidence gap for the intended broader coupling-method framing.
