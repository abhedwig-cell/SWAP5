...
- living canonical reconciled by F-TA04: `2a6eb532c922add0afbc15fdf7f3bee11ed8ea33`
...
F-TA04 checked the exact Status-A authority tree at `992a5c657bfe10a10100f92e0cb77c4825ae65b6` and the F-TA04 implementation-base tree at `e9859b82ffa0d0776c340ef7d550ac8791e28dab`, then reconciled the relevant delta through living canonical `2a6eb532c922add0afbc15fdf7f3bee11ed8ea33`. None of these seven strings resolves to a repository file on either checked locator tree, and the later canonical delta does not touch these test surfaces. They must therefore be interpreted as historical/narrative suite labels in the immutable release-readiness record, not as executable repository locators.
...
The replay materializes F-VQ65 and F-VQ71 independent oracles at their pinned authorities and replays transaction/mass, restart and accepted-publication invariants against F-TB11's exact source generation. The central test-bank catalog records this as a complete bounded historical preservation chain. It does not promote F-TB11 into a moving-current authority for `992a5c…`, `e9859b82…`, `2a6eb532…` or later heads.
