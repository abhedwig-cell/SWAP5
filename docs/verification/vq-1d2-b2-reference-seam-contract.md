...
The current real B2 candidate remains blocked because no integrated production seam exists. The staged SWAP-004 legacy candidate does not alter that production observation. No seam is invented by this verification layer.
