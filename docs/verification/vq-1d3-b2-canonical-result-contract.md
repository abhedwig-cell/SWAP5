...
The current B2 production entrypoint, seam and result contract are absent, so B1.9 -> B2 numerical comparison remains blocked. No synthetic result is accepted as production evidence.
