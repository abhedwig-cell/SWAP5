...
| Current preservation | Current Status-A traceability names same-tree F-GC29 targeted groundwater tests, mixed smoke and accepted-state publication/rollback preservation. | `docs/status-a/TRACEABILITY.md` | F-DOC24 does not reinterpret the historical F-GC29 response-sensitivity workunit as the original scientific admission of Groundwater Coupling v1. |
