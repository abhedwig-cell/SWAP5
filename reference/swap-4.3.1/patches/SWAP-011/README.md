...
- `historical/E7_SW011_fix.patch`: immutable recovered historical E7 patch bytes;
- `apply_and_verify.py`: byte-safe ordered-preimage applicator;
- `tests/README.md`: regression and qualification map.

The stored `fix.patch` is deliberately **not relabelled as the historical E7 patch**. The immutable historical E7 patch has SHA-256 `9ccf4ec48462ea5f84684e3ee5c93b72bcb2b1c584dc3bdff47a4a0ec0621110`. The ordered B1.10 admission transform has SHA-256 `1d3daab13d90036da3bc112ccd2c57ebcd56ac0970cce03d856cb6ede1249238` and preserves the already admitted SWAP-009, SWAP-010 and SWAP-012 semantics.
...
The one-shot transport/materialization machinery used to persist the exact mixed-line-ending patch was removed after successful materialization; its commits and successful Actions run remain in branch history as audit evidence.
