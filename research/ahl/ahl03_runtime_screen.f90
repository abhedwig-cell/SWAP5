program ahl03_runtime_screen
  ...
  real(real64) :: t_analytic(NREP), t_direct(NREP), t_logit(NREP)
  real(real64) :: checksum_a, checksum_d, checksum_l
  integer :: i, rep
  ...
  if (.not. ieee_is_finite(checksum_a + checksum_d + checksum_l)) error stop 'non-finite benchmark checksum'
...
end program ahl03_runtime_screen
