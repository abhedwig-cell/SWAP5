#!/usr/bin/env python3
"""F-AHL11E full-catalog build at globally tightened logK tolerance."""
...
mats=parse_catalog()
summary={"work_unit":"F-AHL11E","catalog_count":len(mats),"C_stop":C_STOP,"logK_tolerance":LOGK_TOL,"materials":{}}
