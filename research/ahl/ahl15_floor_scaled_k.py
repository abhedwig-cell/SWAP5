#!/usr/bin/env python3
"""F-AHL15 floor-scaled conductivity adaptive builder.
...
K_FLOOR=1e-10
LN10=math.log(10.0)
OUT=pathlib.Path(sys.argv[1] if len(sys.argv)>1 else "/tmp/ahl15")
...
summary={"work_unit":"F-AHL15","K_floor":K_FLOOR,"materials":{}}
for mid,p in base.MATERIALS.items():
    ...
    summary["materials"][mid]={
        ...
        "pass":e[0]<=THETA_TOL and e[1]<=LOGC_TOL and e[2]<=K_TOL
    }
