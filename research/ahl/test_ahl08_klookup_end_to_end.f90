program test_ahl08_klookup_end_to_end
  ...
  call bind_ahl08_klookup_provider(lookup,hp,total_dt,trim(table_path),valid)
  ...
  write(*,'(A,1X,ES16.8,1X,A,1X,ES16.8,1X,A,1X,F10.6)') &
       'AHL08_TIMING_ANALYTICAL_S',analytical_times(2),'SPLIT_S',split_times(2),'RATIO',split_times(2)/analytical_times(2)
...
end program test_ahl08_klookup_end_to_end
