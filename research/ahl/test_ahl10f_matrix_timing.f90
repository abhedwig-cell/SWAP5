program test_ahl10f_matrix_timing
  ...
  integer, parameter :: NREPLAY=8192, NTIMING=5
  ...
  do r=1,NTIMING
    ...
    write(*,'(A,1X,I0,1X,ES18.10,1X,ES18.10,1X,F10.6)') 'AHL10F_PAIR',r,ref_times(r),candidate_times(r),ratios(r)
  end do
  call sort5(ratios)

  write(*,'(A,1X,ES14.6,1X,A,ES14.6,1X,A,ES14.6,1X,A,ES14.6,1X,A,ES14.6)') &
       'AHL10F_FIDELITY MAX_DH=',max_dh,'MAX_DTHETA=',max_dw,'DTOP=',dtop,'DBOTTOM=',dbottom,'MASS=',mass
  write(*,'(A,1X,F10.6)') 'AHL10F_MEDIAN_PAIRED_RATIO',ratios(3)
  write(*,'(A,1X,F10.6)') 'AHL10F_MEDIAN_REDUCTION_FRACTION',1.0_real64-ratios(4)
  write(*,'(A)') 'AHL10F_FIDELITY=PASS'
...
end program test_ahl10f_matrix_timing
