program test_ahl28_fmr_cache_accounting
  ...
  write(*,'(A,I0,1X,A,I0,1X,A,I0,1X,A,I0)') 'AHL28_FMR_CACHE_BEFORE BUILDS=',builds0,'HITS=',hits0,'MISSES=',misses0,'ENTRIES=',entries0
  write(*,'(A,I0,1X,A,I0,1X,A,I0,1X,A,I0)') 'AHL28_FMR_CACHE_AFTER BUILDS=',builds1,'HITS=',hits1,'MISSES=',misses1,'ENTRIES=',entries1
  write(*,'(A,I0)') 'AHL28_FMR_ADVANCES ',NREPLAY
  write(*,'(A,I0)') 'AHL28_FMR_HIT_DELTA ',hits1-hits0
  call require(hits1-hits0==NREPLAY,'one warm cache acquisition per adaptive physical advance')
  call require(builds1==builds0 .and. misses1==misses0 .and. entries1==entries0,'warm cache remains stable')
  write(*,'(A)') 'AHL28_FMR_CACHE_ACCOUNTING=PASS'
...
contains
  ...
  subroutine require(cond,msg)
    ...
    if(.not.cond)then
      write(*,'(A,1X,A)')'AHL28_FMR_CACHE_FAIL',trim(msg);error stop 1
    end if
  end subroutine
end program test_ahl28_fmr_cache_accounting
