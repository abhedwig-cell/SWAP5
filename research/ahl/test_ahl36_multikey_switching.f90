program test_ahl36_multikey_switching
  ...
  write(*,'(A,1X,ES18.10)') 'AHL36_SAME_KEY_SEC_PER_BIND',t_same(3)
  write(*,'(A,1X,ES18.10,1X,A,F12.4)') 'AHL36_SWITCH16_SEC_PER_BIND',t16(3), &
       'RATIO_TO_SAME=',t16(3)/max(t_same(3),tiny(1.0_real64))
  write(*,'(A,1X,ES18.10,1X,A,F12.4)') 'AHL36_SWITCH64_SEC_PER_BIND',t64(3), &
       'RATIO_TO_SAME=',t64(3)/max(t_same(3),tiny(1.0_real64))
  write(*,'(A,4(1X,I0))') 'AHL36_CACHE_BEFORE',b0,h0,m0,e0
  write(*,'(A,4(1X,I0))') 'AHL36_CACHE_AFTER',b1,h1,m1,e1
  ...
  write(*,'(A)') 'AHL36_CHARACTERIZATION=PASS'
...
contains
  ...
  subroutine require(cond,msg)
    ...
    if(.not.cond)then
      write(*,'(A,1X,A)') 'AHL36_FAIL',trim(msg)
      error stop 1
    end if
  end subroutine require
end program test_ahl36_multikey_switching
