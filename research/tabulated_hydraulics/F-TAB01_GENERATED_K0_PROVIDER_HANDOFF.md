# F-TAB01 generated K0 hydraulics provider — production handoff
...
F-TAB01 must preserve all of the following.
...
7. **No legacy table-input revival**
   - Generic external `SWSOPHY=1` remains outside F-TAB01.
   - Legacy table files and globals must not become the production ownership model.

## Required implementation slices

### F-TAB01-A — immutable generated-provider state
...
### F-TAB01-B — typed provider implementation
...
### F-TAB01-C — provider selection and lifetime ownership
...
### F-TAB01-D — transaction and temporal qualification
...
### F-TAB01-E — performance qualification
...
### F-TAB01-F — whole-application gate
