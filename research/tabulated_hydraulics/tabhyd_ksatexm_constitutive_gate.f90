program tabhyd_ksatexm_constitutive_gate
  ...
  do q=1,NSCAN
    ...
    do i=1,NODES
      ...
      if ((relsa>cof(11,i)) .neqv. (relst>cof(11,i))) mismatch=mismatch+1
  ...
  write(*,'(a,2(1x,es24.16))') 'KX01_SAT_ANALYTIC',ka
  write(*,'(a,2(1x,es24.16))') 'KX01_SAT_CANDIDATE',kc
  ...
  write(*,'(a,2(1x,es24.16))') 'KX01_HM1_ANALYTIC',ka
  write(*,'(a,2(1x,es24.16))') 'KX01_HM1_CANDIDATE',kc

  h=-5.0_real64
  call analytic_on%evaluate(h,ta,ka,ca,da)
  call analytic_off%evaluate(h,td,kd,cd,dd)
  below_kdiff=maxval(abs(ka-kd))
  write(*,'(a,es24.16)') 'KX01_BELOW_THRESHOLD_ANALYTIC_ON_OFF_MAX=',below_kdiff
  ...
  write(*,'(a,es24.16)') 'KX01_THETA_MAX_ABS=',max_theta
  write(*,'(a,es24.16)') 'KX01_C_MAX_ABS=',max_c
  write(*,'(a,es24.16)') 'KX01_LOG10K_MAX_ABS=',max_logk
  write(*,'(a,es24.16)') 'KX01_BRANCH_K_MAX_ABS=',max_branch_abs
  ...
  write(*,'(a,2(1x,es24.16))') 'KX01_KTHR',cof(12,1),cof(12,2)
  write(*,'(a)') 'KX01_CONSTITUTIVE_GATE_COMPLETED'
end program tabhyd_ksatexm_constitutive_gate
