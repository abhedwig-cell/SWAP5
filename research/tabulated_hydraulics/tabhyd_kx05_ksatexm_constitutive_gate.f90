program tabhyd_kx05_ksatexm_constitutive_gate
  ...
  do q=1,NSCAN
    ...
    do i=1,NODES
      ...
      if ((relsa>cof(11,i)) .neqv. (h(i)>=first_active(i))) mismatch=mismatch+1
      if (h(i)>=first_active(i)) then
  ...
  do q=1,10001
    ...
    do i=1,NODES
      relsa=(ta(i)-cof(1,i))/(cof(2,i)-cof(1,i))
      relst=(tt(i)-cof(1,i))/(cof(2,i)-cof(1,i))
      if ((relsa>cof(11,i)) .neqv. (h(i)>=first_active(i))) then
  ...
  write(*,'(a,2(1x,es24.16))') 'KX05_SAT_ANALYTIC',ka
  write(*,'(a,2(1x,es24.16))') 'KX05_SAT_CANDIDATE',kc
  ...
  write(*,'(a,2(1x,es24.16))') 'KX05_HM1_ANALYTIC',ka
  write(*,'(a,2(1x,es24.16))') 'KX05_HM1_CANDIDATE',kc

  h=-5.0_real64
  call analytic_on%evaluate(h,ta,ka,ca,da)
  call analytic_off%evaluate(h,td,kd,cd,dd)
  below_kdiff=maxval(abs(ka-kd))
  write(*,'(a,es24.16)') 'KX05_BELOW_THRESHOLD_ANALYTIC_ON_OFF_MAX=',below_kdiff
  ...
  write(*,'(a,es24.16)') 'KX05_THETA_MAX_ABS=',max_theta
  write(*,'(a,es24.16)') 'KX05_C_MAX_ABS=',max_c
  write(*,'(a,es24.16)') 'KX05_LOG10K_MAX_ABS=',max_logk
  write(*,'(a,es24.16)') 'KX05_BRANCH_K_MAX_ABS=',max_branch_abs
  write(*,'(a,es24.16)') 'KX05_BRANCH_K_MAX_REL=',max_branch_rel
  write(*,'(a,es24.16)') 'KX05_TRANSITION_K_MAX_ABS=',max_transition_abs
  write(*,'(a,i0)') 'KX05_BRANCH_CLASS_MISMATCH=',mismatch
  write(*,'(a,i0)') 'KX05_BRANCH_CLASS_MISMATCH_LOCAL=',mismatch_local
  write(*,'(a,2(1x,i0))') 'KX05_BRANCH_CLASS_MISMATCH_NODE',mismatch_node
  write(*,'(a,2(1x,es24.16))') 'KX05_BRANCH_MISMATCH_HMIN',mismatch_hmin
  write(*,'(a,2(1x,es24.16))') 'KX05_BRANCH_MISMATCH_HMAX',mismatch_hmax
  write(*,'(a,i0)') 'KX05_ACTIVE_SAMPLES=',active_count
  write(*,'(a,es24.16)') 'KX05_CONTINUITY_LOCAL_JUMP=',continuity_jump
  write(*,'(a,2(1x,es24.16))') 'KX05_THRESHOLDS',cof(11,1),cof(11,2)
  write(*,'(a,2(1x,es24.16))') 'KX05_KTHR',cof(12,1),cof(12,2)
  write(*,'(a,es24.16)') 'KX05_ACTIVE_F_MIN=',fmin_active
...
end program tabhyd_kx05_ksatexm_constitutive_gate
