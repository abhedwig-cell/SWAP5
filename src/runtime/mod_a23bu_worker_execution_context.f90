module mod_a23bu_worker_execution_context
  ...
  type, public :: a23bu_headcalc_scratch_t
  ...
  end type a23bu_headcalc_scratch_t

  type, public :: a23bu_solver_history_t
    logical :: flwarn = .true.
    integer :: iwarn = 0
    integer :: nstep = 0
  end type a23bu_solver_history_t

  type, public :: a23bu_solver_diagnostics_t
  ...
  end type a23bu_numerical_control_t

  type, public :: a23bu_execution_time_t
  ...
  end type a23bu_execution_time_t

  type, public :: a23bu_reporting_progress_t
  ...
  end type a23bu_reporting_progress_t

  type, public :: a23bu_worker_context_t
    integer :: worker_id = -1
...
contains
  ...
  end subroutine a23bu_reset_attempt_control

  subroutine a23bu_reset_all_numerical_control(worker)
    type(a23bu_worker_context_t), intent(inout) :: worker
    worker%control = a23bu_numerical_control_t()
  end subroutine a23bu_reset_all_numerical_control

  subroutine a23bu_seed_timestep_control(worker, dt, dtmin)
    type(a23bu_worker_context_t), intent(inout) :: worker
  ...
  end subroutine a23bu_seed_timestep_control

  subroutine a23bu_request_dt_reduction(worker)
    type(a23bu_worker_context_t), intent(inout) :: worker
    worker%control%request_dt_reduction = .true.
  end subroutine a23bu_request_dt_reduction

  subroutine a23bu_seed_execution_window(worker, t0, t1, legacy_start, legacy_end)
    type(a23bu_worker_context_t), intent(inout) :: worker
    ...
    call a23bu_reset_calendar_events(worker)
  end subroutine a23bu_seed_execution_window

  subroutine a23bu_reset_calendar_events(worker)
    type(a23bu_worker_context_t), intent(inout) :: worker
  ...
  subroutine a23bu_seed_reporting_progress(worker)
    type(a23bu_worker_context_t), intent(inout) :: worker
    worker%reporting = a23bu_reporting_progress_t()
  end subroutine a23bu_seed_reporting_progress

  subroutine a23bu_record_internal_retry(worker)
    type(a23bu_worker_context_t), intent(inout) :: worker
  ...
  end function a23bu_reporting_shim_payload_bytes

  integer function a23bu_scratch_payload_bytes(worker) result(bytes)
