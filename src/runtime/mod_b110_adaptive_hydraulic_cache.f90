module mod_b110_adaptive_hydraulic_cache
  ...
  contains
    ...
    procedure :: stats => b110_adaptive_cache_stats
  end type b110_adaptive_hydraulic_cache_t

  public :: make_b110_adaptive_hydraulic_key, b110_adaptive_same_key
...
contains
  ...
  logical function b110_adaptive_same_key(a,b) result(equal)
  ...
  subroutine b110_adaptive_get_or_build(self,key,parameters,provider,table,was_hit,ok)
    ...
    ok=.true.
  end subroutine b110_adaptive_get_or_build

  subroutine b110_adaptive_cache_stats(self,builds,hits,misses,entries)
