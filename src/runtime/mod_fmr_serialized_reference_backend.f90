  ...
  logical function fmr_serialized_execution_admitted(self, parameters, numerical_config)
    ...
    type is (fmr_b110_physical_parameters_t)
      ...
      if (parameters%generated_mvg_acceleration_active) then
        ...
        ! F-TAB03 research: F-SI39 KSATEXM is admitted here only through
        ! the already-qualified generated-state exact overlay. All other
        ! F-TAB02 composition guards remain unchanged.
