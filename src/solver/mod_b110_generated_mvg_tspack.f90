module mod_b110_generated_mvg_tspack
  ! Minimal private 1-D TSPACK closure required by F-TAB02.
  !
  ! Numerical routines are source-preserved from the public SWAP transitional
  ! lineage SWAP-model/SWAP@2a5ace1c06be7a257b64e9ac1896b489533f16e9,
  ! which carries Robert J. Renka's TSPACK tension-spline implementation.
  ! Legacy table I/O, global table state, inverse interpolation and unrelated
  ! TSPACK routines are deliberately not transferred.
  private
  public :: TSPBI, my_HVAL, my_HPVAL
contains
...
end module mod_b110_generated_mvg_tspack
