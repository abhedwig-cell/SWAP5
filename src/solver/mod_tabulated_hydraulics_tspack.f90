! F-TAB02 production-local numerical dependency.
! Source lineage: SWAP-model/SWAP@2a5ace1c06be7a257b64e9ac1896b489533f16e9
! Extracted only as the generic TSPACK interpolation mathematics; no legacy table state or SWSOPHY ownership is included.
module mod_tabulated_hydraulics_tspack
...
end module mod_tabulated_hydraulics_tspack
