...
# EB-I18 must exercise the already qualified EB-I13 physical thermal profile.
# A bottom thermal publication requested on a column with soil temperature
# disabled cannot legitimately materialize a thermal candidate.
