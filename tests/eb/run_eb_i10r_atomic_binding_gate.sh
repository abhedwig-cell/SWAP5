...
CANONICAL=2a0db2524fba6e258316ce82630c60ea1c9c673a
BUILD="${RUNNER_TEMP:-/tmp}/eb-i10r-${GITHUB_RUN_ID:-local}"
rm -rf "$BUILD"; mkdir -p "$BUILD/o0" "$BUILD/o2"
trap 'rm -rf "$BUILD"' EXIT
fail(){ echo "EB_I10R_GATE_FAIL $*" >&2; exit 110; }

# Current-canonical race guard. EB-I10R is a current-canonical owner candidate,
...
assert a['canonical_base']=='2a0db2524fba6e258316ce82630c60ea1c9c673a'
