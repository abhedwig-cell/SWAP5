...
gfortran "${COMMON[@]}" -J "$BUILD" -I "$BUILD" -c tests/fahl/test_fahl49_matrix.f90 -o "$BUILD/test.o"
...
test "$(grep -c 'FAHL49_MATRIX .* PASS' "$RESULT")" -eq 12
echo 'FAHL49_MATRIX_12_OF_12=PASS'
