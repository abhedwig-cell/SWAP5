...
checks={
 ...
 'restore_config_fail_closed':all(x in process for x in ('thermal/config mismatch','solute/config mismatch','irrigation/config mismatch','crop/config mismatch','solute mode mismatch')),
