...
cd "$ROOT"
fail(){ echo "FCI109R1_GATE_FAIL $*" >&2; exit 109; }

CANONICAL=43577e083ae1e315d86cafd55f971d80279db27c
...
echo 'FCI109R1_EXACT_FIVE_FILE_PRODUCTION_DELTA=PASS'
...
echo 'FCI109R1_FAPP09_FVQ128_POSTIMAGES=PASS'
...
echo 'FCI109R1_OWNER_REPLAY=PASS'
echo 'FCI109R1_INDEPENDENT_REPLAY=PASS'
echo 'F-CI109R1 FAPP09 CURRENT CANONICAL ADMISSION GATE PASS'
