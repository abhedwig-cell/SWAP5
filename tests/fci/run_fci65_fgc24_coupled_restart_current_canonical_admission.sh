...
fail(){ echo "FCI65_GATE_FAIL $*" >&2; exit 265; }

CANONICAL="52d66ba612096184327f58a076ef22bd0119e237"
CANONICAL_TREE="426291c690546ab5faaa96e1498e991372f2c3e7"
...
PREREG="integration/f-ci/F-CI65_PRE_REGISTRATION.json"
AUDIT="integration/f-ci/F-CI65_ARCHITECTURE_AUDIT.json"
STATUS="integration/f-ci/F-CI65_STATUS.json"
...
assert p['canonical_base']['sha']=='52d66ba612096184327f58a076ef22bd0119e237'
