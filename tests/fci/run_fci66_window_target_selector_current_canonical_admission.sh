...
# Immutable dependencies: F-CI66 changes the interval scheduler seam only.
...
if grep -Eiq 'ROSSFAST|D3R|0\.0016' "$RUNTIME"; then
...
echo 'FCI66_CURRENT_CANONICAL_WINDOW_TARGET_SELECTOR_ADMISSION=PASS'
