program test_fci08_legacy_trial_capsule
  ...
  use MOD_irrigation, only: dayfix,nirri,qssdi
  ...
  ipos_qtop=-9; ipos_tetop=-9; ipos_tebot=-9; dayfix=-9; nirri=-9
  ...
  if(dayfix/=6 .or. nirri/=2) error stop 'irrigation rollback copy'
