...
canonical_restart="9770a659d5a93d9abe1341815b57c0fb2fea15ec"
donor="7c1c5251a2dff94291db381cf0b66631b81e9f05"
canonical_closeout_path="integration/f-ci/F-CI51P_STATUS.json"
canonical_closeout_blob="c828da40c5b9874e43e8eaca5380d79b4592b2fa"
allowed=(
...
test "$(git rev-parse "HEAD:$canonical_closeout_path")" = "$canonical_closeout_blob"
...
echo "FGC18R_R1_CURRENT_CANONICAL_CLOSEOUT_BLOB=PASS:$canonical_closeout_blob"
echo "FGC18R_R1_DONOR_ANCESTRY=PASS:$donor"
echo 'FGC18R_R1_SCOPE_ALLOWLIST=PASS'
echo 'FGC18R_R1_FGC17_CONTRACT_LOCK=PASS'
echo 'FGC18R_R1_RESERVATION_FREE_LIST=PASS'
