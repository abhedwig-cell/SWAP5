...
BUILD="${RUNNER_TEMP:-${TMPDIR:-/tmp}}/swap5-fgc31-qbot-projection-${GITHUB_RUN_ID:-local}-$$"
mkdir -p "$BUILD"
trap 'rm -rf "$BUILD"' EXIT
cd "$ROOT"
fail(){ echo "FGC31_QBOT_PROJECTION_GATE_FAIL $*" >&2; exit 31; }
...
echo 'FGC31_QBOT_PROJECTION_O0_O2_EXACT_IDENTITY=PASS'
cat "$BUILD/o0/output.txt"
echo 'F-GC31 QBOT DRAINAGE PROJECTION GATE PASS'
