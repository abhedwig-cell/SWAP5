...
BUILD="${TMPDIR:-/tmp}/swap5-fkt02-gate-$$"
...
TEST="$ROOT/tests/fkt/test_fkt02_candidate_lineage.f90"

python3 "$ROOT/tools/fkt/fkt02_contract_gate.py"
...
echo 'FKT02_FOCUSED_O0_O2_GATE PASS'
