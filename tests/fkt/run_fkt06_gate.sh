...
BUILD="${TMPDIR:-/tmp}/swap5-fkt06-gate-$$"
...
TEST="$ROOT/tests/fkt/test_fkt06_optional_continuation.f90"

# Preserve the complete previously-qualified F-KT05 boundary first.
bash "$ROOT/tests/fkt/run_fkt05_gate.sh"
python3 "$ROOT/tools/fkt/fkt06_contract_gate.py"
...
echo 'FKT06_FOCUSED_O0_O2_GATE PASS'
