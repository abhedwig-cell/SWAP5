...
grep -Fq 'FMR09_HETEROGENEOUS_ROOT_ROUTE=PASS' "$OUT/output.txt"
grep -Fq 'FMR09_EXPLICIT_ROOT_LEGACY_QROT_POISON_IMMUNITY=PASS' "$OUT/output.txt"
grep -Fq 'FMR09_ROOT_ROLLBACK=PASS' "$OUT/output.txt"
grep -Fq 'FMR09_ROOT_REPLAY_BITWISE=PASS' "$OUT/output.txt"
grep -Fq 'FMR09_ROOT_A_B_A=PASS' "$OUT/output.txt"
