...
echo "APPROX03_T2C_MINUS_DISCOVERY_SUMMARY|ROWS=$rows|REFINED=$refined"
[[ $refined -ge 1 ]] || fail "B01 wet minus has no stable multi-substep reference workload"
echo "FPE_APPROX03_T2C_MINUS_DISCOVERY=PASS"
