program test_fpe_newton_candidate01_profile
  ...
  write(*,'(*(g0))') 'NEWTON_CANDIDATE01_PROFILE|MODE=',trim(mode),'|CALLS=',calls,'|STATUS=',result%status, &
...
end program test_fpe_newton_candidate01_profile
