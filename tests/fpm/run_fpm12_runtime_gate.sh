...
for opt in 0 2; do
  ...
  for marker in FPM12_ACCEPTED_ONCE=PASS FPM12_STANDALONE_SERIALIZED_MULTISWAP_EQUIVALENCE=PASS FPM12_REJECT_ZERO_PUBLICATION=PASS FPM12_STALE_OUTPUT_CLEARED=PASS FPM12_REJECT_COMMITTED_STATE_EXACT=PASS FPM12_REJECT_THEN_ACCEPT=PASS FPM12_REJECT_REJECT_ACCEPT_NO_ACCUMULATION=PASS FPM12_RETRY_EXHAUSTION_NO_PUBLICATION=PASS FPM12_RETRY_EXHAUSTION_COMMITTED_STATE_EXACT=PASS FPM12_RETRY_ORACLE=PASS; do
...
echo 'FPM12_REJECT_IMMUTABILITY=PASS_EXACT_COMMITTED_STATE'
echo 'FPM12_RETRY_PROVENANCE=PASS'
echo 'FPM12_MASS_PRESERVATION=PASS_NO_SECOND_BOOKING'
echo 'FPM12_STANDALONE_SERIALIZED_MULTISWAP_EQUIVALENCE=PASS'
