...
for opt in 0 2; do
  ...
  for marker in FPM12_ACCEPTED_ONCE=PASS FPM12_STANDALONE_SERIALIZED_MULTISWAP_EQUIVALENCE=PASS FPM12_REJECT_ZERO_PUBLICATION=PASS FPM12_STALE_OUTPUT_CLEARED=PASS FPM12_REJECT_THEN_ACCEPT=PASS FPM12_REJECT_REJECT_ACCEPT_NO_ACCUMULATION=PASS FPM12_RETRY_EXHAUSTION_NO_PUBLICATION=PASS FPM12_RETRY_ORACLE=PASS; do
