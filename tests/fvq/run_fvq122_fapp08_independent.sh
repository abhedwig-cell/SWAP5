...
SUBJECT=4e320330928f6d9cab9149afa3c40a5b2529f9d4
...
for opt in 0 2; do
  ...
  gfortran "${COMMON[@]}" -Wno-error=compare-reals -O"$opt" -J "$OUT" -I "$OUT" -c tests/fvq/test_fvq122_fapp08_independent.f90 -o "$OUT/test.o"
  ...
  for m in F_VQ122_SURFACE_SWEEP=PASS F_VQ122_ROOT_SWEEP=PASS F_VQ122_INACTIVE_CROP_ZERO=PASS F_VQ122_FAIL_CLOSED=PASS; do
