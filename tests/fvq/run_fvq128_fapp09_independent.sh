...
for opt in 0 2; do
  ...
  for marker in     F_VQ128_SINGLE_LEVEL_SCOPE=PASS     F_VQ128_MATERIALIZER_FAIL_CLOSED=PASS     F_VQ128_OWNER_XOR=PASS     F_VQ128_FIXED_CARRIER_XOR=PASS     F_VQ128_ACCEPTED_WINDOW_POSITIVE_EXCHANGE=PASS     F_VQ128_WINDOW_VS_TERMINAL_ADVANCE=PASS     F_VQ128_DISCARDED_FULL_TRIAL_EXCLUDED=PASS     F_VQ128_MISMATCH_DISCARD_REPLAY=PASS     F_VQ128_BASE_STATE_PRESERVED=PASS     F_VQ128_ACCEPTED_WINDOW_NEGATIVE_EXCHANGE=PASS     F_VQ128_SIGNED_TRANSACTION_COMMIT=PASS     F_VQ128_STALE_ORIGIN_FAIL_CLOSED=PASS     F_VQ128_FAPP09_INDEPENDENT=PASS; do
