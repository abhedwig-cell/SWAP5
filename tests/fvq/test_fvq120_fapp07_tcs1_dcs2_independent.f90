program test_fvq120_fapp07_tcs1_dcs2_independent
  ...
  print '(A)','F_VQ120_B110_EQUATION_ORACLE=PASS'
  print '(A)','F_VQ120_TCSFIX_CADENCE=PASS'
  print '(A)','F_VQ120_SPLIT_ROLLBACK_REPLAY=PASS'
  print '(A)','F_VQ120_A_B_A=PASS'
  print '(A)','F_VQ120_FAIL_CLOSED=PASS'
contains
  ...
  subroutine require(ok,n)
    ...
    if(.not.ok) then
      write(*,'(A,I0)') 'F_VQ120_FAIL=',n
      error stop 1
    end if
  end subroutine
end program test_fvq120_fapp07_tcs1_dcs2_independent
