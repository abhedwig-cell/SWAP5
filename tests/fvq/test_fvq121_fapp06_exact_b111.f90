program test_fvq121_fapp06_exact_b111
  ...
  write(*,'(A,I0)') 'F_VQ121_EXACT_B111_RECORDS=',n
  write(*,'(A,ES24.16)') 'F_VQ121_EXACT_B111_MAX_ERROR=',maxerr
  write(*,'(A)') 'F_VQ121_EXACT_3505_PROCESS_AND_BINDING=PASS'
contains
...
end program test_fvq121_fapp06_exact_b111
