program test_fvq122_fapp08_independent
  ...
  print '(A)','F_VQ122_SURFACE_SWEEP=PASS'
  print '(A)','F_VQ122_ROOT_SWEEP=PASS'
  print '(A)','F_VQ122_INACTIVE_CROP_ZERO=PASS'
...
end program test_fvq122_fapp08_independent
