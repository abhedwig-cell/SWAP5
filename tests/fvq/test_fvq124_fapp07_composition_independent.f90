program test_fvq124_fapp07_composition_independent
  ...
  write(*,'(A,I0)') 'F_VQ124_COMPOSITION_RECORDS=',n
  write(*,'(A,I0)') 'F_VQ124_COMPOSITION_SWINTER0=',n0
  write(*,'(A,I0)') 'F_VQ124_COMPOSITION_SWINTER3=',n3
  write(*,'(A,ES24.16)') 'F_VQ124_COMPOSITION_MAX_ERROR=',maxerr
  write(*,'(A)') 'F_VQ124_EXACT_110_BINDING_COMPOSITION=PASS'
contains
  ...
  subroutine require(ok,n)
    ...
    integer,intent(in)::n
    if(.not.ok) then
      write(*,'(A,I0)') 'F_VQ124_COMPOSITION_FAIL=',n
      error stop 1
    end if
  end subroutine
end program test_fvq124_fapp07_composition_independent
