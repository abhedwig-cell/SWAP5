program test_fwof40_producer
  ...
  type(fmr_wofost_accepted_window_t) :: window1
  ...
  call fwof40_require(len_trim(path) > 0, 'producer artifact path')
...
end program test_fwof40_producer
