...
PREIMAGE=9d202705d1d7063ae129166b1049f7555a7ad802
...
# Current-canonical inherited authorities must remain exact.
...
test "$(git rev-parse HEAD:$REFERENCE_BACKEND)" = 960ea116cad81e8c0db8a579982f4999b3d085ed
