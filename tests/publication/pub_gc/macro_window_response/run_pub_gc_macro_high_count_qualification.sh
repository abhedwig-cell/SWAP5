...
DECISION_BLOB="9e74a021185befcbcd89b98bb26228777b0d5ea0"
SPEC_COMMIT="e6cfc6f23e169e6941c3bae405f2ac92c71cc392"
SPEC_PATH="docs/publications/PUB-GC_MACRO_HIGH_COUNT_EXTENSION_SPEC.md"
SPEC_BLOB="b23448e53365a7cae2239b7519439169963d476c"
MANIFEST_COMMIT="0f896ab1fb41af8fe8bd8971fe2fc5873dc07748"
MANIFEST_PATH="docs/publications/manifests/PUB-GC-MACRO-WINDOW-QUAL-0003.yaml"
MANIFEST_BLOB="575211b3dcc1e1e443e36cffb044f4d50589338d"
...
RUNNER="$DIR/run_pub_gc_macro_high_count_qualification.sh"
WORKFLOW=".github/workflows/pub-gc-macro-high-count-qualification.yml"

fail(){ echo "PUB_GC_MACRO_HIGH_COUNT_RUN_FAIL $*" >&2; exit 97; }
...
echo "PUB_GC_MACRO_HIGH_COUNT_DECISION_LOCK=PASS:$DECISION_COMMIT:$DECISION_BLOB"
echo "PUB_GC_MACRO_HIGH_COUNT_SPEC_LOCK=PASS:$SPEC_COMMIT:$SPEC_BLOB"
echo "PUB_GC_MACRO_HIGH_COUNT_MANIFEST_LOCK=PASS:$MANIFEST_COMMIT:$MANIFEST_BLOB"
echo "PUB_GC_MACRO_HIGH_COUNT_PRODUCTION_SRC_UNCHANGED=PASS:$SOURCE_TREE"
echo "PUB_GC_MACRO_HIGH_COUNT_QUALIFIED_DEPENDENCIES_UNCHANGED=PASS"
...
for opt in 0 2; do
  ...
  echo "PUB_GC_MACRO_HIGH_COUNT_O${opt}=PASS"
done
...
echo "PUB_GC_MACRO_HIGH_COUNT_O0_O2_IDENTITY=PASS"
echo "PUB_GC_MACRO_HIGH_COUNT_OUTPUT_SHA256=$(sha256sum "$BUILD/o0/output.txt" | awk '{print $1}')"
echo "PUB_GC_MACRO_HIGH_COUNT_HEAD=$(git rev-parse HEAD)"
echo "PUB_GC_MACRO_HIGH_COUNT_SOURCE_TREE=$(git rev-parse HEAD:src)"
echo "PUB_GC_MACRO_HIGH_COUNT_MODULE_BLOB=$(git rev-parse HEAD:$MODULE)"
echo "PUB_GC_MACRO_HIGH_COUNT_TEST_BLOB=$(git rev-parse HEAD:$TEST)"
echo "PUB_GC_MACRO_HIGH_COUNT_RUNNER_BLOB=$(git rev-parse HEAD:$RUNNER)"
echo "PUB_GC_MACRO_HIGH_COUNT_QUALIFICATION=PASS"
