...
SPEC_COMMIT="f55b87322a04977b342e00057b3bd47375580233"
SPEC_PATH="docs/publications/decisions/PUB-GC_NATIVE_TIME_REFINEMENT_AFTER_0002.md"
SPEC_BLOB="9e74a021185befcbcd89b98bb26228777b0d5ea0"
MANIFEST_COMMIT="c464a9dcc09ae4cc190ce52b90da9d3f3e91f9f5"
MANIFEST_PATH="docs/publications/manifests/PUB-GC-NATIVE-TIME-0003.yaml"
MANIFEST_BLOB="49f5552ffff1b8de685d417d1130b1f64fe52769"

DIR="tests/publication/pub_gc/native_time_0003"
MACRO_MODULE="tests/publication/pub_gc/macro_window_response/mod_pub_gc_macro_window_response.f90"
TEST="$DIR/test_pub_gc_native_time_0003.f90"
RUNNER="$DIR/run_pub_gc_native_time_0003.sh"
WORKFLOW=".github/workflows/pub-gc-native-time-0003.yml"
...
grep -Fq "native_dt(nlevel)=[0.01_real64,0.005_real64,0.0025_real64,0.00125_real64,0.000625_real64,0.0003125_real64]" "$TEST" || fail "frozen ladder missing"
...
echo "PUB_GC_NATIVE_0003_DECISION_LOCK=PASS:$SPEC_COMMIT:$SPEC_BLOB"
echo "PUB_GC_NATIVE_0003_MANIFEST_LOCK=PASS:$MANIFEST_COMMIT:$MANIFEST_BLOB"
echo "PUB_GC_NATIVE_0003_MACRO_MODULE_LOCK=PASS:$MACRO_MODULE_BLOB"
echo "PUB_GC_NATIVE_0003_PRODUCTION_SRC_UNCHANGED=PASS:$SOURCE_TREE"
echo "PUB_GC_NATIVE_0003_QUALIFIED_DEPENDENCIES_UNCHANGED=PASS"
...
for opt in 0 2; do
  ...
  grep -Eq '^PUB_GC_NATIVE_POLICY_SELECTION=(SELECT_N0_0P01000_DAY|SELECT_N1_0P00500_DAY|SELECT_N2_0P00250_DAY|SELECT_N3_0P00125_DAY|SELECT_N4_0P000625_DAY|NO_POLICY_SELECTED|NO_POLICY_SELECTED_FINE_LEVEL_UNSTABLE)$' "$OUT/output.txt" || fail "O$opt invalid selection token"
