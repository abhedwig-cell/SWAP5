...
BASE="b0f72c6c740ded2e331bb9dfce678a36bedac731"
SOURCE_TREE="d7ef6c045263de821db7800459289efcd8a6420b"
MACRO_MODULE_BLOB="0a9461368f536381ca23390b255f8c369cb1e474"
SPEC_COMMIT="f581b112add1ae2c7bf6dcce37557eaa22cf21a7"
SPEC_PATH="docs/publications/decisions/PUB-GC_NATIVE_TIME_REFINEMENT_AFTER_0003.md"
SPEC_BLOB="fb86dc34d092f04942253ed0a6bc2732ba30159a"
MANIFEST_COMMIT="6f28b6b9646ebfa856634356f1794e182bc73a9f"
MANIFEST_PATH="docs/publications/manifests/PUB-GC-NATIVE-TIME-0004.yaml"
MANIFEST_BLOB="b8458f0fda4b7598fc05024d22d5b0e756e1b5c7"

DIR="tests/publication/pub_gc/native_time_0004"
MACRO_MODULE="tests/publication/pub_gc/macro_window_response/mod_pub_gc_macro_window_response.f90"
TEST="$DIR/test_pub_gc_native_time_0004.f90"
RUNNER="$DIR/run_pub_gc_native_time_0004.sh"
WORKFLOW=".github/workflows/pub-gc-native-time-0004.yml"
...
grep -Fq "native_dt(nlevel)=[0.01_real64,0.005_real64,0.0025_real64,0.00125_real64,0.000625_real64,0.0003125_real64,0.00015625_real64,0.000078125_real64]" "$TEST" || fail "frozen ladder missing"
...
echo "PUB_GC_NATIVE_0004_DECISION_LOCK=PASS:$SPEC_COMMIT:$SPEC_BLOB"
echo "PUB_GC_NATIVE_0004_MANIFEST_LOCK=PASS:$MANIFEST_COMMIT:$MANIFEST_BLOB"
echo "PUB_GC_NATIVE_0004_MACRO_MODULE_LOCK=PASS:$MACRO_MODULE_BLOB"
echo "PUB_GC_NATIVE_0004_PRODUCTION_SRC_UNCHANGED=PASS:$SOURCE_TREE"
echo "PUB_GC_NATIVE_0004_QUALIFIED_DEPENDENCIES_UNCHANGED=PASS"
...
for opt in 0 2; do
  ...
  timeout 1200s "$OUT/test" > "$OUT/output.txt" 2>&1 || {
  ...
  grep -Eq '^PUB_GC_NATIVE_POLICY_SELECTION=(SELECT_N0_0P01000_DAY|SELECT_N1_0P00500_DAY|SELECT_N2_0P00250_DAY|SELECT_N3_0P00125_DAY|SELECT_N4_0P000625_DAY|SELECT_N5_0P0003125_DAY|SELECT_N6_0P00015625_DAY|NO_POLICY_SELECTED|NO_POLICY_SELECTED_FINE_LEVEL_UNSTABLE)$' "$OUT/output.txt" || fail "O$opt invalid selection token"
