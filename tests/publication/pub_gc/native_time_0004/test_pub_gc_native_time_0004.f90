program test_pub_gc_native_time
  ...
  integer, parameter :: ncase=5, nlevel=8
  ...
  integer, parameter :: interval_count(nlevel)=[4,8,16,32,64,128,256,512]
  real(real64), parameter :: native_dt(nlevel)=[0.01_real64,0.005_real64,0.0025_real64,0.00125_real64,0.000625_real64,0.0003125_real64,0.00015625_real64,0.000078125_real64]
  ...
  if(fine_guard) then
    do ic=1,ncase
      call compare_levels(r(ic,7),r(ic,8),level_ok,'FINE',ic)
  ...
  if(.not.all_valid) then
    ...
    do il=1,7
      level_ok=.true.
      do ic=1,ncase
        call compare_levels(r(ic,il),r(ic,8),ok,'SELECT',ic)
      ...
      if(level_ok) then
        ...
        case(4); selection='SELECT_N3_0P00125_DAY'
        case(5); selection='SELECT_N4_0P000625_DAY'
        case(6); selection='SELECT_N5_0P0003125_DAY'
        case(7); selection='SELECT_N6_0P00015625_DAY'
        end select
        exit
      end if
    end do
