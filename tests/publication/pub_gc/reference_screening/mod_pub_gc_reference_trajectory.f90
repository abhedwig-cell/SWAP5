module mod_pub_gc_reference_trajectory
  ...
  public :: pub_gc_run_reference_level

contains

  subroutine pub_gc_run_reference_level(coupling_window_day, number_of_windows, level, status)
    ...
    real(real64) :: q_accepted, residual_accepted
    ...
    call configure_case(parameters, initial_state, forcing_template, base_head_cm, coupling_window_day)
    ...
    call gw%initialize(gw_service_id, gw_lineage_id, 0.0_real64, initial_time_day, gw_area_m2, gw_sy, &
    ...
    do w = 1, number_of_windows
      ...
      call gc_ref_bisect(evaluate_active_residual, 0.0_real64, 0.10_real64, 1.0e-8_real64, &
      ...
      call reconstruct_prepare_commit(solution, q_accepted, residual_accepted, local_status)
    ...
    call clear_active_context()
  end subroutine pub_gc_run_reference_level
  ...
  subroutine reconstruct_prepare_commit(solution, q_accepted, residual_accepted, status)
...
end module mod_pub_gc_reference_trajectory
