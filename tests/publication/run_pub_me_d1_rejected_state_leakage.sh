...
echo "PUB_ME_D1_CLEAN_RAW_BEGIN"
grep -E '^PUB_ME_D1_(REJECT_|CONTINUATION_|FINAL_)' "$BUILD/clean/o0/d1-output.txt"
echo "PUB_ME_D1_CLEAN_RAW_END"
echo "PUB_ME_D1_MUTANT_RAW_BEGIN"
grep -E '^PUB_ME_D1_(REJECT_|CONTINUATION_|FINAL_)' "$BUILD/mutant/o0/d1-output.txt"
echo "PUB_ME_D1_MUTANT_RAW_END"
echo "PUB_ME_D1_FULL_STACK_RAW_BEGIN"
grep -E '^PUB_P1E02_' "$BUILD/mutant/o0/p1e02-output.txt"
echo "PUB_ME_D1_FULL_STACK_RAW_END"
