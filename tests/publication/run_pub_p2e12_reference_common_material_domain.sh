...
for opt in 0 2; do
  ...
  for marker in     'PUB_P2E12_PHYSICAL_CASE_COUNT=300'     'PUB_P2E12_TEMPORAL_LEVEL_COUNT=1'     'PUB_P2E12_TRIAL_PAIR_COUNT=300'     'PUB_P2E12_ROSSFAST_SOLVER_EXECUTED=FALSE'     'PUB_P2E12_THRESHOLD_FROZEN=FALSE'     'PUB_P2E12_REFERENCE_TOLERANCE_CHANGED=FALSE'     'PUB_P2E12_REFERENCE_COMMON_MATERIAL_DOMAIN_GATE=PASS'; do
