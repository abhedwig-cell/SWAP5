program test_pub_p2e11_reference_material_extension_calibration
  ...
  do idt=1,ndt
    ...
    call require(ip==nphys,'exact 180 physical cases at the frozen temporal level')
  end do
  ...
  write(*,'(A)') 'PUB_P2E11_THRESHOLD_FROZEN=FALSE'
  ...
  if (selected_dt_index==0) then
    write(*,'(A)') 'PUB_P2E11_COMMON_DOMAIN_STATUS=BLOCKED_EXTENSION_REFERENCE_DOMAIN'
    write(*,'(A)') 'PUB_P2E11_SCIENTIFIC_OUTCOME=NEGATIVE_EXTENSION_REFERENCE_DOMAIN_INCOMPLETE'
    write(*,'(A)') 'PUB_P2E11_REFERENCE_MATERIAL_EXTENSION_CALIBRATION_GATE=PASS'
    stop
  end if
  ...
  write(*,'(A)') 'PUB_P2E11_COMMON_DOMAIN_STATUS=QUALIFIED_COMPLETE_EXTENSION_REFERENCE_DOMAIN'
  write(*,'(A)') 'PUB_P2E11_SCIENTIFIC_OUTCOME=QUALIFIED_COMPLETE_EXTENSION_DOMAIN'
  write(*,'(A)') 'PUB_P2E11_REFERENCE_MATERIAL_EXTENSION_CALIBRATION_GATE=PASS'
...
end program test_pub_p2e11_reference_material_extension_calibration
