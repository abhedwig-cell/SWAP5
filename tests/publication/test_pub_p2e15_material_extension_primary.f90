program test_pub_p2e15_material_extension_primary
  ...
  call require(case_id==expected_cases,'exact 180-case material-extension matrix attempted')
  ...
  write(*,'(A)') 'PUB_P2E15_MATERIAL_EXTENSION_PRIMARY_GATE=PASS'
...
end program test_pub_p2e15_material_extension_primary
