...
def main()->int:
    ...
    recon=[x for x in lines if x.startswith("RZM06E08_RECON|")]
    forcing=[x for x in lines if x.startswith("RZM06E08_FORCING|")]
    probe=[x for x in lines if x.startswith("RZM06E08_PROBE|")]
    ...
    result={
      "schema":"swap5.gc_rootzone_memory.rzm06e08.rootmatched_interface_memory_probe.v1",
      "preregistration_commit":"91d00f62a1150a8310296ba0ee877b9c1842cfa4",
      ...
      "order_independence":any(x=="GC_RZM06E08_ORDER_INDEPENDENCE=PASS" for x in lines),
    ...
    if admitted_a and admitted_b:
        ...
        result["decision"]=(
          ...
          if support else "NO_SUPPORT_AT_1E9_SELECTED_PAIR"
        )
    else:
        result["probe"].update({
    ...
    result["interpretation_boundary"]=[
      "Support means H_c plus W_profile and W_root30 do not determine a unique next interface exchange at the frozen 1e-9 cm aggregate-storage resolution for this selected C01 pair/window.",
    ...
    print("RZM06E08_RESULT_JSON",json.dumps(result,sort_keys=True,separators=(",",":")))
    print("GC_RZM06E08_ANALYSIS=PASS")
    return 0
