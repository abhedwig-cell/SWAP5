...
for opt in 0 2; do
  ...
  for marker in \
    'GC_LOW01_CARRIER_EXPLICIT_BOTTOM_FACE=PASS' \
    'GC_LOW01_CARRIER_BRANCH_CLASSIFICATION=PASS' \
    'GC_LOW01_CARRIER_NODE_SNAP=PASS' \
    'GC_LOW01_CARRIER_TYPED_GWL_SEPARATE_FROM_RAW=PASS' \
    'GC_LOW01_CARRIER_QBOT_AND_STATE_EXACT_COPY=PASS' \
    'GC_LOW01_CARRIER_BITWISE_REPLAY=PASS' \
    'GC_LOW01_CARRIER_GATE=PASS'; do
