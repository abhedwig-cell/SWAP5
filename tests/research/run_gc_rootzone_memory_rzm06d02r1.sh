...
fail(){ echo "GC_RZM06D02R1_GATE_FAIL $*" >&2; exit 1; }
...
for opt in 0 2; do
  ...
  grep -Fq 'GC_RZM06D02R1_COMMON_TIME_RESEED=PASS' "$BUILD/d02r1-o$opt.txt" || fail "PASS marker O$opt"
done
cmp "$BUILD/d02r1-o0.txt" "$BUILD/d02r1-o2.txt" || fail "O0/O2 output drift"
sha256sum "$BUILD/d02r1-o0.txt" "$BUILD/d02r1-o2.txt"
echo 'GC_RZM06D02R1_O0_O2_IDENTITY=PASS'
echo 'GC_RZM06D02R1_RESEED_QUALIFICATION=PASS'
