...
PREREG=446300e92b135c8dffee833f7f5b85876bb75ca2
EVIDENCE="${RZM06E03E_EVIDENCE_DIR:-$ROOT/RZM06E03E-EVIDENCE}"
mkdir -p "$EVIDENCE"
fail(){ echo "GC_RZM06E03E_GATE_FAIL $*" >&2; exit 1; }
...
do
  ...
  echo "GC_RZM06E03E_SOURCE_IDENTITY_${label}=PASS"
done

python3 tests/research/test_gc_rootzone_memory_rzm06e03e_census.py   --d04 "$D04/d04-o2.txt"   --e01 "$E01/e01-o2.txt"   --e03 "$E03/e03-o2.txt"   --e03b "$E03B/e03b-o2.txt"   --e03c "$E03C/e03c-o2.txt" | tee "$EVIDENCE/census.txt"

grep -Fq 'GC_RZM06E03E_RESPONSE_BLIND_CENSUS=PASS' "$EVIDENCE/census.txt" || fail "census marker"
...
echo 'GC_RZM06E03E_QUALIFICATION=PASS'
