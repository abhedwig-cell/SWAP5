...
grep -Fq '"decision": "DYN02_VIEW01_QUALIFIED_RESTRICTED_TEMPORAL_CARRIER"' integration/research/HYDRO_MEMORY_DYN02_VIEW01_RESULT.json || fail "DYN02-VIEW01 authority missing"
