module mod_hydro_memory_acc02_f2_bridge
  ...
  public :: hydro_memory_acc02_f2_begin_next_window_c
...
contains
  ...
  integer(c_int) function hydro_memory_acc02_f2_begin_next_window_c(accepted_groundwater_head_m,hcof,rhs,reference_head) &
       bind(C,name="hydro_memory_acc02_f2_begin_next_window_c")
    ...
    hydro_memory_acc02_f2_begin_next_window_c=1_c_int
    ...
    if(status/=0)return
    accepted_interface_ready=.true.
    hydro_memory_acc02_f2_begin_next_window_c=0_c_int
  end function hydro_memory_acc02_f2_begin_next_window_c
  ...
  subroutine initialize_forcing(f,q)
    ...
    f%root_extraction_sink(1:min(4,numnod))=ROOT_TOTAL/real(min(4,numnod),real64)
...
end module mod_hydro_memory_acc02_f2_bridge
