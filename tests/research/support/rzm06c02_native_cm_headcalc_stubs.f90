...
module MOD_grid
  implicit none
  integer, parameter :: numnod = 17
  ! GC-RZM06C02 research-only native HeadCalc geometry in centimetres.
  ! 0-30 cm: 6 x 5 cm; 30-100 cm: 7 x 10 cm; 100-300 cm: 4 x 50 cm.
  real(8), parameter :: z(numnod) = [ &
       -2.5d0, -7.5d0, -12.5d0, -17.5d0, -22.5d0, -27.5d0, &
       -35.0d0, -45.0d0, -55.0d0, -65.0d0, -75.0d0, -85.0d0, -95.0d0, &
       -125.0d0, -175.0d0, -225.0d0, -275.0d0 ]
  real(8), parameter :: dz(numnod) = [ &
       5.0d0, 5.0d0, 5.0d0, 5.0d0, 5.0d0, 5.0d0, &
       10.0d0, 10.0d0, 10.0d0, 10.0d0, 10.0d0, 10.0d0, 10.0d0, &
       50.0d0, 50.0d0, 50.0d0, 50.0d0 ]
  real(8), parameter :: disnod(numnod+1) = [ &
       2.5d0, 5.0d0, 5.0d0, 5.0d0, 5.0d0, 5.0d0, 7.5d0, &
       10.0d0, 10.0d0, 10.0d0, 10.0d0, 10.0d0, 10.0d0, 30.0d0, &
       50.0d0, 50.0d0, 50.0d0, 25.0d0 ]
end module MOD_grid
