...
bash tests/transaction/run_a23bl_gate.sh | tee "$BUILD/transaction.txt"
grep -Fq 'A23BL_TRANSACTION_GATE PASS' "$BUILD/transaction.txt" || fail "transaction acceptance regression"
