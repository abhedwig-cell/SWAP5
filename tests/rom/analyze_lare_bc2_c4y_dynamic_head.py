...
HISTS={"Y01":0.70,"Y02":0.80,"Y03":0.90,"Y04":0.75}
NSTEPS=1024
OBS_DT=0.0008
DT=0.0001
EQ_TOL=1.0e-12
...
bc=load_module("bc1_c4y_base",HERE/"run_lare_bc1_stage_b.py")
...
def c4y_boundary_psi(history,sym,psi0):
...
bc.symbol=c4y_symbol
bc.boundary_psi=c4y_boundary_psi
...
def main():
    ...
    assert p["phase"]=="PREREGISTERED_BEFORE_C4Y_REFERENCE_RESPONSE"
    ...
    if not integrity:
        decision="C4Y_REFERENCE_OR_EXECUTION_BLOCKED"
    elif profile:
        decision="C4Y_DYNAMIC_HEAD_GW_PROFILE_FRONTIERS_PRESENT"
    elif gw:
        decision="C4Y_DYNAMIC_HEAD_GW_FRONTIER_ONLY"
    else:
        decision="C4Y_DYNAMIC_HEAD_REDUCED_FRONTIER_NOT_PRESERVED"

    out={
      "schema":"swap5.lare.bc2.c4y.result.v1",
      "workstream":"F-ROM-LARE","work_unit":"LARE-BC2-C4Y",
      ...
      "interpretation_boundaries":[
        ...
        "C4Y tests fixed-domain prescribed-head semantics only; it is not moving-water-table geometry and not groundwater-coupling authority.",
