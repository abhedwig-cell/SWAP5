...
p2=load_module("rom_purpose_p4_surface_reference_policy",HERE/"analyze_rom_purpose_p2_reference.py")
p1=load_module("rom_purpose_p4_gw_reference_policy",HERE/"analyze_rom_purpose_p1_reference.py")
...
def main()->int:
    ...
    status=(
        "P4_REFERENCE_QUALIFIED_CANDIDATES_AUTHORIZED"
        if qualified else "P4_REFERENCE_NOT_QUALIFIED_STOP_BEFORE_CANDIDATES"
    )
    out={
      "schema":"swap5.rom-purpose.p4.reference-result.v1",
      "workstream":"ROM-PURPOSE",
      "work_unit":"ROM-PURPOSE-P4-REFERENCE",
      "status":status,
