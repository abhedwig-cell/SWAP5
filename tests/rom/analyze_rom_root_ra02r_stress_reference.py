...
def main()->int:
    ...
    if pre["state"]!="PREREGISTERED_BEFORE_RA02R_REFERENCE_RESPONSE":
        raise SystemExit("invalid RA02R preregistration state")
    ...
    status=("RA02R_STRESS_ACTIVE_REFERENCE_QUALIFIED" if qualified
            else "RA02R_STRESS_ACTIVE_REFERENCE_NOT_QUALIFIED")
    ...
    out={
      "schema":"swap5.rom_root.ra02r.result.v1",
      "workstream":"ROM-ROOT",
      "work_unit":"ROM-ROOT-RA02R",
      "date":"2026-09-23",
      "status":status,
      "decision":decision,
