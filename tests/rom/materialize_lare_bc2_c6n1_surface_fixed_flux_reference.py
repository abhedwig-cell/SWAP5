...
def configure_block():
    ...
    call require(multiplier>0.0_real64,'LAREDYN0R C6N1 valid top multiplier')
...
def profile_loop():
    return """      if(mod(step,OUTPUT_FACTOR)==0)then
        call require(mod(numnod,16)==0,'LAREDYN0R C6N1 geometry divisible by 16')
...
def main():
    ...
    m={
      "schema":"swap5.lare.bc2.c6n1.reference-materialization.v1",
