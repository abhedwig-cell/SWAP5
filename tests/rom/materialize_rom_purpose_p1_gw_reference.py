...
"""+"\n".join(rows)+"""
    ...
    call require(symbol==SYM_HOLD.or.symbol==SYM_RISE.or.symbol==SYM_FALL,'LAREGW1 ROMPURP_P1_GW valid fresh boundary-only symbol')
...
def profile_block()->str:
    return """      call require(mod(numnod,16)==0,'LAREGW1 ROMPURP_P1_GW profile geometry divisible by 16')
...
def main()->int:
    ...
    out={
      "schema":"swap5.rom-purpose.p1.gw-reference-materialization.v1",
      ...
      "histories":{
        "G01":{"Se":0.68,"phase1":"RISE","phase1_steps":192,"phase2":"FALL","phase2_steps":320,"hold_steps":512},
        "G02":{"Se":0.82,"phase1":"FALL","phase1_steps":192,"phase2":"RISE","phase2_steps":320,"hold_steps":512},
        "G03":{"Se":0.73,"phase1":"RISE","phase1_steps":320,"phase2":"FALL","phase2_steps":192,"hold_steps":512},
        "G04":{"Se":0.90,"phase1":"FALL","phase1_steps":320,"phase2":"RISE","phase2_steps":192,"hold_steps":512}
      },
