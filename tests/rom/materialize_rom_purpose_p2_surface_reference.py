...
SE={1:0.64,2:0.76,3:0.86,4:0.93}
PHASES={
  1:("WET","DRY","WET","DRY"),
  2:("DRY","WET","DRY","WET"),
  3:("WET","DRY","WET","DRY"),
...
def configure_block():
    ...
    call require(multiplier>0.0_real64,'LAREDYN0R ROMPURP_P2_SURFACE valid top multiplier')
...
def main():
    ...
    m={
      "schema":"swap5.rom-purpose.p2.surface-reference-materialization.v1",
      ...
      "response_based":False,"p1_surface_histories_reused":False
    }
