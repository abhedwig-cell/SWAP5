...
"""+"\n".join(rows)+"""
    ...
    call require(symbol==SYM_HOLD.or.symbol==SYM_RISE.or.symbol==SYM_FALL,'LAREGW1 ROMPURP_P3_GW valid fresh boundary-only symbol')
...
def profile_block()->str:
    return """      call require(mod(numnod,16)==0,'LAREGW1 ROMPURP_P3_GW profile geometry divisible by 16')
...
def main()->int:
    ...
    out={
      "schema":"swap5.rom-purpose.p3.gw-reference-materialization.v1",
      ...
      "histories":{
        "G06":{"Se":0.70,"phase1":"RISE","phase1_steps":256,"phase2":"FALL","phase2_steps":384,"hold_steps":384},
        "G07":{"Se":0.78,"phase1":"FALL","phase1_steps":256,"phase2":"RISE","phase2_steps":384,"hold_steps":384},
        "G08":{"Se":0.86,"phase1":"RISE","phase1_steps":384,"phase2":"FALL","phase2_steps":384,"hold_steps":256},
        "G09":{"Se":0.92,"phase1":"FALL","phase1_steps":384,"phase2":"RISE","phase2_steps":384,"hold_steps":256}
      },
