...
SE={1:0.73,2:0.81,3:0.87,4:0.93}
PHASES={
  1:("WET","DRY","WET","DRY"),
  2:("DRY","WET","DRY","WET"),
  3:("WET","DRY","WET","DRY"),
...
def configure_block():
    ...
    call require(multiplier>0.0_real64,'LAREDYN0R ROMPURP_P4_SURFACE valid top multiplier')
...
def main():
    ...
    text=one(text,"  write(*,'(A)') 'LAREDYN0R_EXECUTION_COMPLETE=PASS'",
             "  write(*,'(A)') 'LAREDYN0R_ROMPURP_P4_SURFACE_REFERENCE_GENERATED=TRUE'"+chr(10)+"  write(*,'(A)') 'LAREDYN0R_ROMPURP_P2_SURFACE_REFERENCE_GENERATED=TRUE'"+chr(10)+"  write(*,'(A)') 'LAREDYN0R_ROMPURP_P1_SURFACE_REFERENCE_GENERATED=TRUE'"+chr(10)+"  write(*,'(A)') 'LAREDYN0R_EXECUTION_COMPLETE=PASS'","marker")
    a.output.write_text(text)

    m={
      "schema":"swap5.rom-purpose.p4.surface-reference-materialization.v1",
