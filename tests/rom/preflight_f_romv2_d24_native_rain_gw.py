...
def main():
    ...
    out={"schema":"swap5.f-romv2-d24.internal-preflight.v1","workstream":"F-ROM","work_unit":"F-ROMV2-D24",
         "decision":"D24_FMC_NATIVE_RAIN_GW_PREFLIGHT_PASS" if passed else "D24_FMC_NATIVE_RAIN_GW_PREFLIGHT_NO_GO",
