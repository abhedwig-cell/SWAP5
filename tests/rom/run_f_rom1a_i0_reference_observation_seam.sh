...
if [[ "$POST_ADMISSION_REPLAY" == "1" ]]; then
  # Moving-current preservation mode: bind the admitted postimage to the exact
  # source blobs that passed the frozen qualification, without requiring the
  # detached preregistration branch commit to be in canonical history.
