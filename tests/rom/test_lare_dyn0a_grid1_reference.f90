program test_lare_dyn0a_grid1_reference
  ...
  material_id=''
  call get_environment_variable('LARE_DYN0A_MATERIAL',material_id,status=env_status)
  call require(env_status==0.and.any(trim(material_id)==['LOAMY_SAND      ','SILT_LOAM       ','SANDY_CLAY_LOAM']), &
       'LAREDYN0R valid GRID1 material')
  bottom_filter=0
  filter_raw=''
  ...
  write(*,'(A,A)') 'LAREDYN0R_MATERIAL=',trim(material_id)
...
contains
  ...
  subroutine initialize_parameters(p)
    ...
    case('LOAMY_SAND')
      tr=0.057_real64;ts=0.41_real64;alpha=0.124_real64
      nn=2.28_real64;ks=350.2_real64;lam=0.5_real64
      p%parameter_set_id=997001_int64
    case('SILT_LOAM')
      tr=0.067_real64;ts=0.45_real64;alpha=0.020_real64
      nn=1.41_real64;ks=10.8_real64;lam=0.5_real64
      p%parameter_set_id=998001_int64
    case('SANDY_CLAY_LOAM')
      tr=0.100_real64;ts=0.39_real64;alpha=0.059_real64
      nn=1.48_real64;ks=31.44_real64;lam=0.5_real64
      p%parameter_set_id=999001_int64
    case default
      call require(.false.,'LAREDYN0R known GRID1 material')
    end select
  ...
  subroutine initialize_identity(col,tmpl)
    ...
    tmpl%template_id=981001_int64;tmpl%physics_topology_id=981002_int64
    tmpl%vertical_layout_id=981003_int64;tmpl%state_layout_id=981004_int64;tmpl%solver_interface_id=981005_int64
...
end program test_lare_dyn0a_grid1_reference