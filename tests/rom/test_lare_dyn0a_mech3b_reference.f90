program test_lare_dyn0a_mech3b_reference
  ...
  call require(env_status==0.and.any(trim(material_id)==['SAND            ','LOAM            ','CLAY            ']), &
...
contains
  ...
  subroutine initialize_parameters(p)
    ...
    case('SAND')
      tr=0.045_real64;ts=0.43_real64;alpha=0.145_real64
      nn=2.68_real64;ks=712.8_real64;lam=0.5_real64
      p%parameter_set_id=991001_int64
    case('LOAM')
      tr=0.078_real64;ts=0.43_real64;alpha=0.036_real64
      nn=1.56_real64;ks=24.96_real64;lam=0.5_real64
      p%parameter_set_id=992001_int64
    case('CLAY')
      tr=0.068_real64;ts=0.38_real64;alpha=0.008_real64
      nn=1.09_real64;ks=4.8_real64;lam=0.5_real64
      p%parameter_set_id=993001_int64
    case default
...
end program test_lare_dyn0a_mech3b_reference