program test_lare_dyn0a_mech4b_reference
  ...
  call require(env_status==0.and.any(trim(material_id)==['SANDY_LOAM      ','SILT            ','CLAY_LOAM       ']), &
       'LAREDYN0R valid blind material')
  bottom_filter=0
  filter_raw=''
...
contains
  ...
  subroutine initialize_parameters(p)
    ...
    case('SANDY_LOAM')
      tr=0.065_real64;ts=0.41_real64;alpha=0.075_real64
      nn=1.89_real64;ks=106.1_real64;lam=0.5_real64
      p%parameter_set_id=994001_int64
    case('SILT')
      tr=0.034_real64;ts=0.46_real64;alpha=0.016_real64
      nn=1.37_real64;ks=6.0_real64;lam=0.5_real64
      p%parameter_set_id=995001_int64
    case('CLAY_LOAM')
      tr=0.095_real64;ts=0.41_real64;alpha=0.019_real64
      nn=1.31_real64;ks=6.24_real64;lam=0.5_real64
      p%parameter_set_id=996001_int64
    case default
      call require(.false.,'LAREDYN0R known blind material')
    end select
...
end program test_lare_dyn0a_mech4b_reference