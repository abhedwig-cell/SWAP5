program test_rom1ar1_reachable_state_library
  ...
  write(*,'(A,I0)') 'ROM1AR1_HISTORY_COUNT=',NHIST
  write(*,'(A,I0)') 'ROM1AR1_DISCOVERY_HISTORY_COUNT=',8
  write(*,'(A,I0)') 'ROM1AR1_HELDOUT_HISTORY_COUNT=',4
  write(*,'(A,I0)') 'ROM1AR1_STATE_COUNT=',total_states
  write(*,'(A,I0)') 'ROM1AR1_DISCOVERY_STATE_COUNT=',8*NSTEPS
  write(*,'(A,I0)') 'ROM1AR1_HELDOUT_STATE_COUNT=',4*NSTEPS
  write(*,'(A,I0)') 'ROM1AR1_TOTAL_FALLBACK_COUNT=',total_fallbacks
  write(*,'(*(g0))') 'ROM1AR1_MAX_ABS_MASS=',max_abs_mass
  write(*,'(A)') 'ROM1AR1_B14_MATERIAL_TRANSFER_GENERATED=FALSE'
  write(*,'(A)') 'ROM1AR1_EXECUTION_COMPLETE=PASS'
...
end program test_rom1ar1_reachable_state_library
