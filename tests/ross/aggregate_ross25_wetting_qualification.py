...
CASE_RE = re.compile(
    r"^F_ROSS25_CASE\|MATERIAL=(?P<material>[^|]+)\|SE=(?P<se>[^|]+)"
...
def main():
    ...
    result={
        "schema":"swap5.f-ross25.tiered-wetting-seam-qualification-result.v1",
        "workunit":"F-ROSS25",
        ...
        "selected_tier_seam_characterization":{
            ...
            "interpretation":"These counts characterize seam crossings on the research reproduction of the selected tier trajectories. They are diagnostic in F-ROSS25 and do not define tangent validity across a seam."
        },
