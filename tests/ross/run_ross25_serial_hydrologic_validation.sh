...
# Canonical descendants may contain unrelated admitted production capabilities.\n# Preserve the exact frozen F-ROSS25 dependency blobs below instead of a\n# repository-global src/reference delta.\n
