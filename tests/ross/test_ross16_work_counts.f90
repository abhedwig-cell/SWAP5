program test_ross16_work_counts
  ...
  write(*,'(A,I0)') 'F_ROSS16_CASE_COUNT=',case_id
  write(*,'(A)') 'F_ROSS16_WORK_COUNT_GATE=PASS'
...
contains
  ...
  subroutine require(condition,label)
    ...
    if (.not.condition) then
      write(*,'(A,1X,A)') 'F_ROSS16_FAIL',trim(label)
      error stop 1
    end if
  end subroutine require
end program test_ross16_work_counts
