...
build_and_run() {
  ...
  gfortran "$opt" -o test_d3r_model_adapter \
    mod_transaction_reference.o mod_canonical_contracts.o mod_rossfast_d3r_model_adapter.o \
    mod_canonical_interval_runtime.o test_f_ross01_d3r_model_adapter.o
