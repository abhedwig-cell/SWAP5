...
build_and_run() {
  ...
  gfortran -std=f2018 -Wall -Wextra -Werror "$opt" -I. -c \
    "$ROOT/src/runtime/mod_rossfast_d3r_execution_policy.f90"
  gfortran -std=f2018 -Wall -Wextra -Werror "$opt" -I. -c \
  ...
  gfortran "$opt" -o test_d3r_model_adapter \
    ...
    mod_rossfast_d3r_execution_policy.o mod_rossfast_d3r_model_adapter.o \
    test_f_ross01_d3r_model_adapter.o
