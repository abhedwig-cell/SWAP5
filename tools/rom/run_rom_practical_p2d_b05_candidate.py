...
DT=0.0001
LEDGER_GATE=1.0e-10
PARTITIONS={"S4":[0.,20.,40.,80.,160.],"G4":[0.,80.,120.,140.,160.],"G6":[0.,80.,100.,120.,140.,150.,160.],"G8":[0.,80.,100.,120.,130.,140.,150.,155.,160.],"U8":[0.,20.,40.,60.,80.,100.,120.,140.,160.]}
...
def main():
    ...
    ap.add_argument("--member",default=None,choices=("G4","G6","G8","U8","S4"))
    ...
    if a.purpose=="GW_LB" and member not in ("G4","G6","G8","U8"): raise SystemExit("GW_LB only G4/G6/G8/U8")
